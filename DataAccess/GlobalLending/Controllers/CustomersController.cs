    ...
    public class CustomersController : ApiController
    {
      //  private GlobalTransactEntities db = new GlobalTransactEntities();
        ...
        public IHttpActionResult PostCustomer(Customer customer)
        {
            ...
            {
                if (CustomerExists(customer.ContactEmail))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = customer.ContactEmail }, customer);
        }
        ...
        {
            return db.Customers.Count(e => e.ContactEmail == id) > 0;
        }
    }
}